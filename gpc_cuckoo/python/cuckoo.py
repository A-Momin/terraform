...
FROM_ADDRESS = 'BBCRedCap3@gmail.com'
REPLY_TO_ADDRESS = 'BBCRedCap3@gmail.com'

CLIENTS = [
    {
        # You'll need to verify this email which is case-sensitive
        'email': 'BBCRedCap3@yahoo.com',
        'first_name': 'AMINUL',
        'last_name': 'MOMIN',
        'pet_name': 'Montu'
    },
...
EMPLOYEES = [
    {
        ...
        'email': 'AminulMomin.NY@gmail.com',
        'first_name': 'Homer',
        'last_name': 'Simpson'
    },
]
...
TEMPLATE_S3_BUCKET = 'gpc-cuckoo-bucket'
#
#
